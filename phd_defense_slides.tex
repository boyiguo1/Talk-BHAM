...
\begin{tcolorbox}[colback=green!5,colframe=green!40!black,title=Question]
How to balance function smoothness and complexity?
\end{tcolorbox}
\end{frame}
...
\tightlist
\item
  Flexible spline function formulation for high-dimensional data via
  \texttt{construct\_smooth\_data}
\end{itemize}
...
Question: Can \(Z_j\) be continuous? Can we have a more flexible model?
\end{frame}
...
Question: Can we have a generalized model that accounts fixed effects,
nonlinear curves, smooth surfaces, and random effects?
\end{frame}
