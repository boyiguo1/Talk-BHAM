...
### Design Matrix of Spline Fucntions
  - Flexible spline function formulation for high-dimensional data via `construct_smooth_data`
  ```{r echo = T, eval= F}
...
Question: Can we have a generalized model that accounts fixed effects, nonlinear curves, smooth surfaces, and random effects?
