...
* Smoothing penalty $\lambda \bs \beta^T \bs S \bs \beta$
  * $\bs S$ is symmetric and positive semi-definite
  * $\bs S = \bm U \bm D \bm U^T$ via eigendecomposing
...
* Structured prior on latent inclusion indicators $\gamma_j$ and $\gamma^\tp_{j}$
$$
...
::: columns
:::: column
* predicting all-cause mortality among patents undergoing cardiac catheterization
