...
* Grouped penalty models
  ...
  * Sparse penalty induces __excess shrinkage__, causing inaccurate interpolation of non-linear effect
...
* Isolate the linear and nonlinear componentsvia eigendecomposing $S_j$
...
* Metrics
  ...
  * Variable Selection Performance: positive predictive value (precision), true positive rate (recall), and Matthews correlation coefficient (MCC)
  
## Prediction Performance

* LASSO performs bad and mgcv performs well
* BHAM performs better than COSSO, adaptive COSSO and spikeSlabGAM
* BHAM performs better than SB-GAM in low-dimensional case but slightly worse in the high-dimensional case
* BHAM is much fater than SB-GAM in fitting models
